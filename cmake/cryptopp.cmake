...
set (CRYPTOPP_HINT_DIRS "${CRYTOPP_HEADER_PATH}" "/opt/homebrew/include" "/usr/local/include")

if (NOT CRYPTOPP_INCLUDE_DIR)
	find_path (CRYPTOPP_INCLUDE_DIR
		NAMES cryptopp/cryptlib.h crypto++/cryptlib.h cryptlib.h
		HINTS ${CRYPTOPP_HINT_DIRS}
	)
endif()
