...
final class AppModel: ObservableObject {
    ...
    @Published var connectionTCPPort: Int = 0
    @Published var connectionUDPPort: Int = 0
    @Published var connectionTCPPortInput: String = ""
    @Published var connectionUDPPortInput: String = ""
    @Published var connectionUDPEnabled: Bool = true
    @Published var connectionED2KEnabled: Bool = true
    @Published var connectionKADEnabled: Bool = true
    @Published var incomingDirectoryInput: String = ""
    ...
    @Published var deadServerRetriesInput: String = "0"
    @Published var addServersFromServer: Bool = false
    @Published var addServersFromClient: Bool = false
    @Published var useServerPrioritySystem: Bool = false
    @Published var smartIDCheck: Bool = false
    @Published var safeServerConnect: Bool = false
    @Published var autoConnectStaticOnly: Bool = false
    @Published var manualHighPriority: Bool = false
    @Published var ipFilterLevelInput: String = ""
    @Published var filterClients: Bool = false
    @Published var filterServers: Bool = false
    @Published var ipFilterAutoUpdate: Bool = false
    @Published var ipFilterUpdateURLInput: String = ""
    @Published var filterLanIPs: Bool = false
    @Published var secureIdentEnabled: Bool = false
    @Published var obfuscationSupported: Bool = false
    @Published var obfuscationRequested: Bool = false
    @Published var obfuscationRequired: Bool = false
    @Published var webServerEnabled: Bool = false
    @Published var webServerPortInput: String = ""
    @Published var webServerGuestEnabled: Bool = false
    @Published var webServerUseGzip: Bool = false
    @Published var webServerRefreshInput: String = ""
    @Published var webServerTemplateInput: String = ""
    @Published var remotePrefsStatisticsSupported: Bool = false
