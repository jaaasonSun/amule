...
public enum ECJsonEnvelopeFixtures {
    public static let messageByOperation: [String: String] = [
        ...
        "download-stop": "{\"ok\":true,\"message\":\"Stop requested\"}",
        "download-a4af-this": "{\"ok\":true,\"message\":\"A4AF swap requested\"}",
        "download-a4af-auto": "{\"ok\":true,\"message\":\"A4AF swap requested\"}",
        "download-a4af-others": "{\"ok\":true,\"message\":\"A4AF swap requested\"}",
        "download-set-category": "{\"ok\":true,\"message\":\"Download category updated\"}",
        ...
        "server-set-static": "{\"ok\":true,\"message\":\"Server static flag updated\"}",
        "server-set-priority": "{\"ok\":true,\"message\":\"Server priority updated\"}",
        "clear-server-info": "{\"ok\":true,\"message\":\"Server log cleared\"}",
        "reset-log": "{\"ok\":true,\"message\":\"Core log cleared\"}",
        ...
        "category-update": "{\"ok\":true,\"message\":\"Category update requested\"}",
        "category-delete": "{\"ok\":true,\"message\":\"Category delete requested\"}",
        "shared-file-priority": "{\"ok\":true,\"message\":\"Shared file priority updated\"}",
        "shared-file-comment-rating": "{\"ok\":true,\"message\":\"Shared file comment updated\"}",
