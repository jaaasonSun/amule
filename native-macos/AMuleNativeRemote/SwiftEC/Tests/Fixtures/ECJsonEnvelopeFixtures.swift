...
public enum ECJsonEnvelopeFixtures {
    ...
    {"ok":true,"sources":[{"client_id":501,"request_file_id":1001,"client_name":"peer","user_ip":"10.0.0.2","user_port":4662,"server_name":"ExampleServer","server_ip":"1.2.3.4","server_port":4661,"software":"aMule","software_version":"2.3.3","download_state":4,"download_state_text":"Downloading","source_from":2,"source_from_text":"Kad","down_speed_kbps":12.5,"available_parts":8,"remote_queue_rank":12,"obfuscation_status":1,"extended_protocol":true,"remote_filename":"fixture.iso"}]}
    """
